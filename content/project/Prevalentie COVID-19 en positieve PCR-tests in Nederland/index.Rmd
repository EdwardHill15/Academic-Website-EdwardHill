...
Max. 2814521, zegge ruim 2.81 miljoen. Aantal inwoners Nederland in 2020 = 17,44 miljoen (2020). 
Dat betekent dat de prevalentie van positieve testen op SARS-CoV-2 is een simpel rekensommetje van 2814521 / 17440000 = 0.1613831, oftewel; 1,6 %. [^note]
...
```{r fig.cap = "Figuur 1: Dagen op de x-as vanaf 27 februari 2020 tot en met 6 december 2021 in Nederland."}
...
```{r fig.cap= "Figuur 2: Dagen op de x-as vanaf 27 februari 2020 tot en met 6 december 2021 in Benelux en Duitsland."}
...
```{r fig.cap = "Figuur 3: Loess line voor prevalentie COVID-19 in Nederland"}
